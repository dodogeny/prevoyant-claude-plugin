...
Prevoyant's Knowledge Base lives at `~/.prevoyant/knowledge-base/` (or the configured `PRX_KB_DIR`). Hermes can read KB files as reference context. Prevoyant writes to the KB; Hermes reads only.
